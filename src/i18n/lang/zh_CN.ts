export default {
    ...
    ConfigFileListView: {
        ...
        workflowDialogs: {
            ...
            missingWorkspaceMessage: '服务器文件夹路径为空。',
            replacePresetTitle: '导入新预设差异？',
            replacePresetCompletedMessage: '将读取新预设并在选择 MOD 页面显示新增/移除差异。移除 MOD 时工具会清理自动挂载内容，但你仍需要检查并修改自己手动配置的内容。是否继续？',
            replacePresetMessage: '将读取新预设并在选择 MOD 页面显示新增/移除差异，不会直接覆盖当前工作预设。',
            replacePresetConfirm: '导入差异',
        }
    },
    ConfigFileEditView: {
        pageTitle: '设置配置文件',
    ...
    ModChooseView: {
        ...
        dependencyConfirmTitle: '需要添加依赖 MOD',
        dependencyConfirmMessage: '{modName} 依赖以下 MOD，是否一起加入？\n{dependencies}',
        dependencySelectionConfirmMessage: '当前已加入 MOD 缺少以下依赖，是否一起加入？\n{dependencies}',
        dependencySelectionInvalid: '当前已加入 MOD 缺少以下依赖，但它们不在当前订阅列表中：\n{dependencies}',
